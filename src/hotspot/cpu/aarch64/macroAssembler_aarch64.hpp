...
public:
  ...
  void protect_return_address(Register return_reg, Register temp_reg, Register base, int offset = 0);
  void authenticate_return_address(Register thread = rthread);
  void authenticate_return_address(Register return_reg, Register temp_reg, Register base, int offset = 0);
